...
// Source: go.ytsaurus.tech/yt/admin/cms/internal/models (interfaces: Cluster)
//
// Generated by this command:
//
//	mockgen -destination=cluster_mock.go -package models . Cluster
//
...
func (mr *MockClusterMockRecorder) GetComponent(path any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClusterMockRecorder) GetHostComponents(host any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClusterMockRecorder) GetMasterCell(cellPath any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClusterMockRecorder) GetNodePoolTree(addr any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetQueueAgents mocks base method.
func (m *MockCluster) GetQueueAgents() (ytsys.QueueAgentMap, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetQueueAgents")
	ret0, _ := ret[0].(ytsys.QueueAgentMap)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetQueueAgents indicates an expected call of GetQueueAgents.
func (mr *MockClusterMockRecorder) GetQueueAgents() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetQueueAgents", reflect.TypeOf((*MockCluster)(nil).GetQueueAgents))
}
...
func (mr *MockClusterMockRecorder) GetTabletCellBundles(n any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClusterMockRecorder) OnNodeDecommission(n any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClusterMockRecorder) Reload(ctx, dc any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
