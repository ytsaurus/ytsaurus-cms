...
// Source: go.ytsaurus.tech/yt/admin/cms/internal/cms (interfaces: SchedulerOrchidClient)
//
// Generated by this command:
//
//	mockgen -destination=scheduler_orchid_client_mock.go -package cms . SchedulerOrchidClient
//
